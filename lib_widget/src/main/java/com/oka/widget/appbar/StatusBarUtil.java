...
public class StatusBarUtil {
    ...
    public static void setDarkMode(Activity activity) {
        ...
        MeizuStatusBarUtils.setStatusBarDarkIcon(activity,false);
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
    ...
    @TargetApi(Build.VERSION_CODES.M)
    public static void setDarkModeMeizu(Activity activity) {
        if (activity==null){return;}
        setMIUIStatusBarDarkIcon(activity, false);
        //setMeizuStatusBarDarkIcon(activity, false);
        MeizuStatusBarUtils.setStatusBarDarkIcon(activity,false);
    ...
    @TargetApi(Build.VERSION_CODES.M)
    public static void clearMode(Activity activity) {
        if (activity==null){return;}
        setMIUIStatusBarDarkIcon(activity, false);
        MeizuStatusBarUtils.setStatusBarDarkIcon(activity,false);
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
     ...
     * @param activity
     */
    public static void setLightStatusSar(Activity activity) {
        if (activity==null){return;}
        setMIUIStatusBarDarkIcon(activity, true);
        //setMeizuStatusBarDarkIcon(activity, true);
        MeizuStatusBarUtils.setStatusBarDarkIcon(activity,true);
    ...
    /**
     * 设置透明状态栏
     * 这个方法调用后，页面布局内容就会延伸至状态栏，状态栏即为透明色。
     * @param activity
     */
